...
//        System.out.println(c);
        ...
        // строку изменить нельзя, это тип (инютебл), можно только создать новую. Два стринга - это два разных объекта
        // При присваивании одного массива другому, у них становится одно место в памяти -> меня значение в одном массиве, меняется значение и в другом
